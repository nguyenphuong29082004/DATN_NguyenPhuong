  ...
  return (
    <header className={`nav-fixed ${scrolled ? 'nav-scrolled' : ''} ${className}`}>
      ...
      <nav className={`nav-mobile-menu ${isMenuOpen ? 'open' : ''}`}>
        <NavLink to="/studio" className="nav-link-mobile" onClick={() => setIsMenuOpen(false)}>Studio</NavLink>
        <NavLink to="/models" className="nav-link-mobile" onClick={() => setIsMenuOpen(false)}>Models</NavLink>
        <NavLink to="/gallery" className="nav-link-mobile" onClick={() => setIsMenuOpen(false)}>Gallery</NavLink>
