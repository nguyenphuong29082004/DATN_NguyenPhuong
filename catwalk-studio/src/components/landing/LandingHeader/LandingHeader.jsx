    ...
    <header className={`nav-fixed ${scrolled ? 'nav-scrolled' : ''} ${className}`}>
      <div className="container-wide nav-container">
        ...
        <div className="nav-actions">
          ...
          >
            <span className="material-symbols-outlined thin-icon" style={{ fontSize: '18px' }}>translate</span>
            <span>{lang === 'vi' ? 'VI' : 'EN'}</span>
          </button>

          <Link to="#" className="nav-app-link">
          ...
          {user && !isAnonymous ? (
            ...
            >
              ...
              <span style={{ fontSize: '14px', fontWeight: '500' }}>{profile?.email || t('common.user')}</span>
            </div>
          ) : (
      ...
      <nav className={`nav-mobile-menu ${isMenuOpen ? 'open' : ''}`}>
        ...
        <button className="nav-link-mobile nav-lang-btn-mobile" onClick={() => { toggleLang(); }}>
          <span className="material-symbols-outlined thin-icon">translate</span>
        ...
        <div className="nav-mobile-cta">
          {user && !isAnonymous ? (
            ...
            >
              ...
              <span style={{ fontSize: '16px', fontWeight: '500' }}>{profile?.email || t('common.user')}</span>
            </div>
          ) : (
