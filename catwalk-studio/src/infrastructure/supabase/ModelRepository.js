...
export class ModelRepository extends IModelRepository {
    ...
    async findById(id) {
        try {
            ...
            if (!resultData) {
                const mockModels = [
                    { model_id: 'm1', username: 'elara_vanguard', display_name: 'Elara Vanguard', status: 'active', is_ai: true, profile_image_url: 'https://images.unsplash.com/photo-1534528741775-53994a69daeb?auto=format&fit=crop&w=800&q=80', style_tags: ['editorial', 'avantGarde'], can_book: true, location: 'London, UK', price_per_image: 15.00, hourly_rate: 150.00, elite: true, account_type: 'both' },
                    { model_id: 'm2', username: 'jaxon_street', display_name: 'Jaxon Street', status: 'active', is_ai: true, profile_image_url: 'https://images.unsplash.com/photo-1506794778202-cad84cf45f1d?auto=format&fit=crop&w=800&q=80', style_tags: ['streetwear', 'commercial'], can_book: true, location: 'New York, USA', price_per_image: 10.00, hourly_rate: 100.00, elite: false, account_type: 'ai_only' },
                    { model_id: 'm3', username: 'sophia_lorenzo', display_name: 'Sophia Lorenzo', status: 'active', is_ai: false, profile_image_url: 'https://images.unsplash.com/photo-1517841905240-472988babdf9?auto=format&fit=crop&w=800&q=80', style_tags: ['runway', 'swimwear', 'commercial'], can_book: true, location: 'Milan, Italy', price_per_image: 25.00, hourly_rate: 300.00, elite: true, account_type: 'real_only' },
                    { model_id: 'm4', username: 'chen_wei', display_name: 'Chen Wei', status: 'active', is_ai: true, profile_image_url: 'https://images.unsplash.com/photo-1542206395-9feb3edaa68d?auto=format&fit=crop&w=800&q=80', style_tags: ['minimalist', 'editorial'], can_book: true, location: 'Tokyo, Japan', price_per_image: 12.00, hourly_rate: 120.00, elite: false, account_type: 'both' },
                    { model_id: 'm5', username: 'isabella_rodriguez', display_name: 'Isabella Rodriguez', status: 'active', is_ai: false, profile_image_url: 'https://images.unsplash.com/photo-1524504388940-b1c1722653e1?auto=format&fit=crop&w=800&q=80', style_tags: ['commercial', 'runway'], can_book: true, location: 'Madrid, Spain', price_per_image: 20.00, hourly_rate: 200.00, elite: true, account_type: 'real_only' },
                    { model_id: 'm6', username: 'zara_nox', display_name: 'Zara Nox', status: 'active', is_ai: true, profile_image_url: 'https://images.unsplash.com/photo-1509631179647-0c77331b092b?auto=format&fit=crop&w=800&q=80', style_tags: ['editorial', 'avantGarde'], can_book: true, location: 'Berlin, Germany', price_per_image: 18.00, hourly_rate: 180.00, elite: true, account_type: 'ai_only' }
                ];
                resultData = mockModels.find(m => m.model_id === id);
            }

            return ModelMapper.toDomain(resultData);
        } catch (error) {
    ...
    async findPublicByUsername(username) {
        try {
            ...
            if (!resultData) {
                ...
                resultData = mockModels.find(m => m.username === username);
            }
    ...
    async findPublic(filters = {}) {
        try {
            ...
            console.error('ModelRepository.findPublic exception:', error);
            // GUARANTEE MOCK DATA ON EXCEPTION
            const mockData = [
                {
                    model_id: 'm1',
                    username: 'elara_vanguard',
            ...
            return mockData.map(row => ModelMapper.toDomain(row));
        }
    }
